...
func TestNewCommand_Flags(t *testing.T) {
	...
	// Check url flag exists (array type)
...
func TestNewCommand_MissingEvent(t *testing.T) {
	t.Parallel()
	...
	cmd := NewCommand(f)
	cmd.SetArgs([]string{"device", "--url", "http://example.com"})
	cmd.SetOut(out)
	cmd.SetErr(errOut)
...
func TestNewCommand_MissingURL(t *testing.T) {
	t.Parallel()
	...
	cmd := NewCommand(f)
	cmd.SetArgs([]string{"device", "--event", "switch.on"})
	cmd.SetOut(out)
	cmd.SetErr(errOut)
...
func TestExecute_WithMock(t *testing.T) {
	...
	cmd.SetOut(&bytes.Buffer{})
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"test-device", "--event", "switch.on", "--url", "http://example.com"})
...
func TestExecute_DeviceNotFound(t *testing.T) {
	...
	cmd.SetOut(&bytes.Buffer{})
	cmd.SetErr(&bytes.Buffer{})
	cmd.SetArgs([]string{"nonexistent-device", "--event", "switch.on", "--url", "http://example.com"})
