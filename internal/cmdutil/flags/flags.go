// Package flags provides embeddable flag structs and helpers for CLI commands.
// This package mirrors the cmdutil/factories/ pattern, providing reusable
// flag definitions that can be embedded in command Options structs.
package flags
