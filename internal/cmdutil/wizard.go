...
func stepDiscovery(_ context.Context, ios *iostreams.IOStreams, opts *InitOptions) ([]discovery.DiscoveredDevice, error) {
	nonInteractive := opts.IsNonInteractive()
	...
	ios.StartProgress(fmt.Sprintf("Discovering devices via mDNS (timeout: %s)...", timeout))
