...
var catalog = []DeviceModel{
	...
	{Slug: "2.5", Name: "Shelly 2.5", Generation: 1, Topology: DualRelay, AltSlugs: []string{"shelly25"},
		Specs: DeviceSpecs{Voltage: "110-240V AC", MaxAmps: 10, PowerMonitoring: true, NeutralRequired: true, Notes: "Dual relay with power metering"}},
	...
	{Slug: "rgbw2", Name: "Shelly RGBW2", Generation: 1, Topology: RGBW, AltSlugs: []string{"shellyrgbw2"},
		Specs: DeviceSpecs{Voltage: "12/24V DC", MaxAmps: 12, NeutralRequired: true, Notes: "4-channel LED controller"}},
	...
	{Slug: "plus-rgbw-pm", Name: "Shelly Plus RGBW PM", Generation: 2, Topology: RGBW, AltSlugs: []string{"shellyplusrgbwpm"},
		Specs: DeviceSpecs{Voltage: "12/24V DC", MaxAmps: 12, PowerMonitoring: true, NeutralRequired: true, Notes: "4-channel LED with power metering"}},
	...
	{Slug: "pro-2pm", Name: "Shelly Pro 2PM", Generation: 2, Topology: DualRelay, AltSlugs: []string{"shellypro2pm"},
		Specs: DeviceSpecs{Voltage: "110-240V AC", MaxAmps: 10, PowerMonitoring: true, NeutralRequired: true, Notes: "DIN rail dual relay"}},
	{Slug: "pro-4pm", Name: "Shelly Pro 4PM", Generation: 2, Topology: QuadRelay, AltSlugs: []string{"shellypro4pm"},
		Specs: DeviceSpecs{Voltage: "110-240V AC", MaxAmps: 10, PowerMonitoring: true, NeutralRequired: true, Notes: "DIN rail quad relay with power metering"}},
	{Slug: "pro-dimmer-1pm", Name: "Shelly Pro Dimmer 1PM", Generation: 2, Topology: Dimmer, AltSlugs: []string{"shellyprodimmer1pm"},
		Specs: DeviceSpecs{Voltage: "110-240V AC", MaxAmps: 1.1, PowerMonitoring: true, NeutralRequired: true, Notes: "DIN rail dimmer"}},
	{Slug: "pro-dimmer-2pm", Name: "Shelly Pro Dimmer 2PM", Generation: 2, Topology: Dimmer, AltSlugs: []string{"shellyprodimmer2pm"},
		Specs: DeviceSpecs{Voltage: "110-240V AC", MaxAmps: 1.1, PowerMonitoring: true, NeutralRequired: true, Notes: "DIN rail dual dimmer"}},
	...
	{Slug: "2pm-gen4", Name: "Shelly 2PM Gen4", Generation: 4, Topology: DualRelay, AltSlugs: []string{"shelly2pmgen4"},
		Specs: DeviceSpecs{Voltage: "110-240V AC", MaxAmps: 10, PowerMonitoring: true, NeutralRequired: true, Notes: "Gen4 dual relay with power metering"}},
