...
func (s *Service) ListKVS(ctx context.Context, identifier string) (*kvs.ListResult, error) {
	var result *kvs.ListResult
...
func (s *Service) GetKVS(ctx context.Context, identifier, key string) (*kvs.GetResult, error) {
	var result *kvs.GetResult
	err := s.WithConnection(ctx, identifier, func(conn *client.Client) error {
		var err error
...
func (s *Service) GetManyKVS(ctx context.Context, identifier, match string) ([]kvs.Item, error) {
	var result []kvs.Item
	err := s.WithConnection(ctx, identifier, func(conn *client.Client) error {
		var err error
...
func (s *Service) GetAllKVS(ctx context.Context, identifier string) ([]kvs.Item, error) {
...
func (s *Service) ExportKVS(ctx context.Context, identifier string) (*kvs.Export, error) {
	var result *kvs.Export
	err := s.WithConnection(ctx, identifier, func(conn *client.Client) error {
		var err error
...
func (s *Service) ImportKVS(ctx context.Context, identifier string, data *kvs.Export, overwrite bool) (imported, skipped int, err error) {
	err = s.WithConnection(ctx, identifier, func(conn *client.Client) error {
