module github.com/tj-smith47/shelly-cli
...
require (
	...
	github.com/tj-smith47/shelly-go v0.2.20-0.20260217060018-ceab5d4949cc
...
require (
	github.com/Wifx/gonetworkmanager/v2 v2.2.0 // indirect
